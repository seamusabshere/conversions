...
Gem::Specification.new do |s|
  ...
  s.files = ["VERSION.yml", "lib/conversions", "lib/conversions/active_record_accessors.rb", "lib/conversions/defaults.rb", "lib/conversions/unit.rb", "lib/conversions.rb", "test/accessor_test.rb", "test/conversions_test.rb", "test/ext_test.rb", "test/test_helper.rb", "test/unit_test.rb"]
  s.has_rdoc = true
